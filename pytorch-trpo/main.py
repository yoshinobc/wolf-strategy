...
def update_params(batch):
    ...
    #print(get_flat_params_from(value_net).double().numpy())
...
for i_episode in count(1):
    ...
    if i_episode % args.log_interval == 0:
        ...
        print("episode {}, ave reward {}".format(i_episode, sum(total_rewards) / len(total_rewards)))
        with open('policy.pkl', 'wb') as f:
            cloudpickle.dump(policy_net, f)

        with open('value.pkl', 'wb') as f:
            cloudpickle.dump(value_net, f)
